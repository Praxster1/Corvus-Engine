...
namespace Corvus
{
    DebugMessenger::DebugMessenger(Instance* instance)
        : m_DebugMessenger(VK_NULL_HANDLE), m_DestroyFunc(nullptr), m_Instance(instance)
    {
#ifndef NDEBUG
    ...
    {
#ifndef NDEBUG
        auto destroyFunc = reinterpret_cast<PFN_vkDestroyDebugUtilsMessengerEXT>(vkGetInstanceProcAddr(
